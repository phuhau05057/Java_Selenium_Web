...
public class Inventory_HN009_VerifyInventoriesAresortedbyCategoryWithASCType extends BaseTest{

    private static final Logger LOGGER = Logger.getLogger(Inventory_HN009_VerifyInventoriesAresortedbyCategoryWithASCType.class);
    final String columnCategory = ConfigurationValue.columnCategory;
    final String sortASC = ConfigurationValue.sortASC;

    @Test
    public void HN009_VerifyInventoriesAresortedbyCategoryWithASCType() throws Exception {
        ...
        inventoryPage.verifySortColumnByASC(columnCategory);
    }
}
