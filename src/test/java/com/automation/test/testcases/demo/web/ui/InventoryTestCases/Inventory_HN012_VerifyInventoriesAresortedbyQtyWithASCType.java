...
public class Inventory_HN012_VerifyInventoriesAresortedbyQtyWithASCType extends BaseTest{

    private static final Logger LOGGER = Logger.getLogger(Inventory_HN012_VerifyInventoriesAresortedbyQtyWithASCType.class);
    final String columnQty = ConfigurationValue.columnQty;


    @Test
    public void HN012_VerifyInventoriesAresortedbyQtyWithASCType() throws Exception {
        ...
        inventoryPage.verifySortColumnByASC(columnQty);
    }
}
